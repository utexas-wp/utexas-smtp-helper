...
- [ ] Create a new release pointing to the new tag at https://github.com/utexas-wp/utexas-smtp-helper/releases/new . Use previous releases as the model for the text of the changelog. **Finally, add the `utexas-eid-auth.zip` file as asset where it says "Attach binaries by dropping them here or selecting them."**
